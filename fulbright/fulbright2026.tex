...
% Shorter ... 27 characters remaining
% Hotter, drier summers and increasing extremes are challenging growers across the world. This is especially clear in Europe where summer heat is increasing faster than anywhere on earth. Maintaining agricultural regions requires understanding of the climate resiliency of current crops, and how to best exploit it. Here I propose to address this by leveraging new data on plant responses to heat extremes and cutting-edge genetics research in Montpellier with my skills in  modeling. Working with one of the world's most economically important crops---winegrapes---we will quantify heat tolerance across varieties and clones to help growers develop climate-smart portfolios
...
Estimates across a large number of cultivars would also help growers develop climate resilient portfolios---selecting the best mix for each grower given their preferences and region.\cite{dempewolf2014adapting,van2019crop,labeyrie2021role} A portfolio of varieties can better handle climate variation year to year, as some varieties may perform best in slightly cooler years and others in slightly warmer years. At the same time, adjusting the mixture over time can help adapt to long-term trends due to anthropogenic climate change.  While the concept of a careful portfolio of climatically matched varieties could clearly help agricultural systems, how much such portfolios are used depends on local practices and the particular crop. It also depends on growers having the information they need on how different varieties respond to climate.\cite{van2019crop}
